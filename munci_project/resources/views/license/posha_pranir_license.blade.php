			...
			<div class="row">
				<div class="col-md-12"> 
					<div class="panel panel-primary">
						<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#ff860a;text-align:center;">পোষা প্রাণীর লাইসেন্স আবেদন</div>
								...
								<div class="row">
									<div class="col-sm-12"> 
										<div class="form-group">
											...
											<div class="col-sm-3">
												<input type="text" name="tika_date" id="tika_date" class="form-control"  placeholder=""/>
											</div>
											<label for="Tax-id" class="col-sm-3 control-label">জলাতংকের টিকা দানের পরবর্তী তারিখ</label>
											<div class="col-sm-3">
												<input type="text" name="tika_next_date" id="tika_next_date" class="form-control"  placeholder=""/>
											</div>
										</div>
