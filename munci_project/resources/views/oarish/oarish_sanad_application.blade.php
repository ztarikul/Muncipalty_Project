			...
			<div class="row">
				<div class="col-md-12"> 
					<div class="panel panel-primary">
						<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#175e0a;text-align:center;">ওয়ারিশ সনদের আবেদন </div>
										...
										<div class="row">
											<div class="col-sm-12"> 
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" name="p_upzila" id="p_upzila" value="Chowmohoni" class="form-control" placeholder=""/>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-sm-12"> 
												<div class="form-group">
													...
													<div class="col-sm-6">
														<input type="text" name="per_upazila" value="Chowmohoni" id="per_thana" class="form-control" />
													</div>
												</div>
											</div>
										</div>
										...
										<div class="row">
											<div class="col-sm-12"> 
												<div class="form-group">
													<label for="Thana-bangla" class="col-sm-6 control-label">উপজেলা </label>
													<div class="col-sm-6">
														<input type="text" name="perb_upazila" value="চৌমুহনী" id="perb_thana" class="form-control" />
													</div>
												</div>
											</div>
										</div>
