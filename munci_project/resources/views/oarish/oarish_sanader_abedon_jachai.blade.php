			...
			<div class="row">
				<div class="col-md-12"> 
					<div class="panel panel-primary">
						<div class="panel-heading" style="font-weight: bold; font-size: 15px;background:#ff860a;text-align:center;">ওয়ারিশ আবেদন যাচাই</div>
									...
									<div class="col-sm-12"> 
										<div class="form-group">
											<div class="col-sm-7 col-sm-offset-2 color-style" style="margin-top:5px;">
												<input type="text" name="tid" id="tid" class="form-control" placeholder="আপনার ওয়ারিশ আবেদনের  ট্র্যাকিং নম্বরটি  ইংরেজিতে প্রবেশ করুন" onkeypress="return numtest();" />
											</div>
											<div class="col-sm-3" style="margin-top:5px;"> 
												<input type="Submit" value="খোঁজ করুন" class="btn btn-primary" name='trade' onclick="htmlData('index.php/show/searchOarishInformation','tid='+tid.value)"/></td>
											</div>
										</div>
									</div>
								</div>
