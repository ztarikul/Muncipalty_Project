...
<head>
  ...
  <!-- animate CSS-->
  <link href="{{asset('admin/asset/css/animate.css')}}" rel="stylesheet" type="text/css"/>
  <!-- Icons CSS-->
  <link href="{{asset('admin/asset/css/icons.css')}}" rel="stylesheet" type="text/css"/>
  <!-- Sidebar CSS-->
  <link href="{{asset('admin/asset/css/sidebar-menu.css')}}" rel="stylesheet"/>
  <!-- Custom Style-->
  <link href="{{asset('admin/asset/css/app-style.css')}}" rel="stylesheet"/>
...
<div class="clearfix"></div>
 ...
 <!-- simplebar js -->
  <script src="{{asset('admin/asset/plugins/simplebar/js/simplebar.js')}}"></script>
  <!-- sidebar-menu js -->
  <script src="{{asset('admin/asset/js/sidebar-menu.js')}}"></script>
  <!-- loader scripts -->
  <script src="{{asset('admin/asset/js/jquery.loading-indicator.js')}}"></script>
  <!-- Custom scripts -->
  <script src="{{asset('admin/asset/js/app-script.js')}}"></script>
  <!-- Chart js -->
