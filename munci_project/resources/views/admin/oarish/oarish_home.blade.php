        ...
        <h4>ওয়ারিশ</h4>
          ...
          <div class="row">
            <div class="col-lg-6 col-xl-3 icon" data-code="f3eb" data-name="shape">
              <a href="javascript:void();"><i class="zmdi zmdi-shape"></i> <span>ওয়ারিশ সনদের আবেদন</span></a>
            </div>
            <div class="col-lg-6 col-xl-3 icon" data-code="f3ec" data-name="spinner">
              <a href="javascript:void();"><i class="zmdi zmdi-spinner"></i> <span>পারিবারিক সনদের আবেদন</span></a>
            </div>
